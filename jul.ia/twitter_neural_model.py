...
base_treinamento = pd.read_csv('./lessons/Train100.csv', delimiter=';')
...
base_treinamento.to_csv('./lessons/base_treinamento_100k_twitter.csv', index=False)
