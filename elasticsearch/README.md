This repository is based on https://github.com/deviantony/docker-elk.

```console
$ git clone https://github.com/alecsena/docker-elk-tweeze
$ cd docker-elk-tweeze
```

To Configure ElasticSearch Password, open file docker-composer.yml and change ELASTIC_PASSWORD attribute.

```console
$ nano docker-compose.yml
```

Now you have to configure hosts, users and passwords on logstash. You do that changing logstash/pipeline/logstash.conf. 
...
input {
  jdbc {
     ...
     jdbc_password => "[postgresql_user_password]"
...
Then you start services locally using Docker Compose:

```console
$ docker-compose up
```

**:warning: Any other settings can be found here below or the original repository. **
