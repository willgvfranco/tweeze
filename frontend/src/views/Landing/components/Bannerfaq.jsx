...
const Bannerfaq = () => (
  ...
  <img
   className="z-over shadow-container-content-5 text-white text-center ajustelogoinicial espaçamentoInicial p-4 p-xl-5"
   src={LogoBranca}
   alt=""
   />  
      <div className="flex-grow-1 w-100 d-flex text-center">
          <div
          ...
          <div className="bg-composed-wrapper--content">
              <div className="mb-4">
                <h4
                  className="text-white display-2 align-self-center">
                  Central de ajuda
                </h4>
